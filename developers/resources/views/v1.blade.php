...
$api_version='v1';
      if(env('APP_ENV')=='local'){
          $api_host=env('API_HOST_LOCAL');
      }else {
          $api_host=env('API_HOST_PRODUCTION');
      }
?>
@extends('layouts.app')
...
@section('content')
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">API 1.0 Documentation</div>
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            <div>
                                <h1 style="color:#1b809e;">RESTful API (V1)</h1>
                                ...
                                <p>
                                    ...
                                    domain.The relative path prefix <code>/<?= $api_version ?>/</code> indicates that we are
                                    currently using <code>version </code> of the API.
                                </p>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><code>/<?= $api_version ?>/register</code></td>
                            ...
                            <div class="table-responsive">
                                <table class="table col-md-9">
                                    ...
                                    <tr>
                                        <td><code>/<?= $api_version ?>/authorize</code></td>
                                        <td><strong>POST</strong></td>
                                        <td><a href="#authorizing_user">Authorizing User account</a></td>
                                    </tr>
                                    <tr>
                                        <td><code>/<?= $api_version ?>/accesstoken</code></td>
                                        <td><strong>POST</strong></td>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><code>/<?= $api_version ?>/me</code></td>
                                        <td><strong>GET</strong></td>
                                        <td><a href="#me">Get User info.</a></td>
                                    </tr>
                                    <tr>
                                        <td><code>/<?= $api_version ?>/logout</code></td>
                                        <td><strong>GET</strong></td>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><code>/<?= $api_version ?>/employees</code></td>
                                        <td><strong>GET</strong></td>
                                    ...
                                    <tr>
                                        <td><code>/<?= $api_version ?>/employees/&ltid&gt</code></td>
    ...
    <pre>
      ...
      <pre>
      curl -X POST \
          <?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/register \
    ...
    <pre>
    curl -X POST \
        <?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/authorize \
      -H 'content-type: application/json' \
      -d '{
      "username":"user123",
      "password":"pass123"
    ...
    <pre>
      ...
      <pre>
      curl -X POST \
          <?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/accesstoken \
      -H 'content-type: application/json' \
      -d '{
    ...
    <pre>
     ...
     -G  '<?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/me'
    ...
    curl -X GET \
          -H "X-Access-Token: 2dadd4bc51a15a41490cdce30383be67" \
          -G  '<?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/logout'
    ...
    curl -X GET \
          -H "X-Access-Token: 2dadd4bc51a15a41490cdce30383be67" \
          -G  '<?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/employees'
    ...
    <pre>
      ...
      <pre>
    curl -X POST \
          '<?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/employees' \
          -H "X-Access-Token: 2dadd4bc51a15a41490cdce30383be67" \
          -H 'content-type: application/json' \
          -d '{
                  "name":"Christy",
    ...
    <pre>
      ...
      <pre>
    curl -X PUT \
          '<?php echo $protocol . "://" . $api_host; ?>/<?= $api_version ?>/employees/1' \
          -H "X-Access-Token: 2dadd4bc51a15a41490cdce30383be67" \
          -H 'content-type: application/json' \
          -d '{
                  "name":"christy james",
